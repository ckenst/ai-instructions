...
How to use (quick)
1. Reference this file from your repository at .github/instructions/mailinator-code-examples.instructions.md
2. Open GitHub Copilot Chat in VS Code and enable workspace/repository context (see instructions below).
3. In the chat input say: "Follow the rules in .github/instructions/mailinator-code-examples.instructions.md and generate a single-file JavaScript demo that <short description>. Name the file <file-name.js>."
...
- "Follow the rules in .github/instructions/mailinator-code-examples.instructions.md and generate a single-file JavaScript demo that lists the 5 most recent messages in a Mailinator inbox. Name the file list-inbox-demo.js."
